...
public class SamouraiSudokuModelTest {

    @Test
    @DisplayName("Quand on le crée un sudoku est vide")
    void testNewSudokuEmpty() {
        SamouraiSudokuModel sudoku = new SamouraiSudokuModel();
    ...
    void testEmptyValueIs0() {
        Assertions.assertEquals(0, SamouraiSudokuModel.EMPTY_VALUE);
    }
    ...
    void testEmptyCell3_3Is0() {
        SamouraiSudokuModel sudoku = new SamouraiSudokuModel();
        Assertions.assertEquals(SamouraiSudokuModel.EMPTY_VALUE, sudoku.getValue(3, 3));
    }
