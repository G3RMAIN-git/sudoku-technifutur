...
public class SodokuModel9x9Test {
    ...
    void testEmptyValueIs0() {
        Assertions.assertEquals(0, SudokuModel9x9.EMPTY_VALUE);
    }
    ...
    void testEmptyCell3_3Is0() {
        SudokuModel9x9 sudoku = new SudokuModel9x9();
        Assertions.assertEquals(SudokuModel9x9.EMPTY_VALUE, sudoku.getValue(3,3));
    }
}
